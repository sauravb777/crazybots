...
def Create_Robot():
    ...
    # pyrosim.Send_Joint( name = "Link2_Link3" , parent= "Link0" , child = "Link3" , type = "revolute", position = [0,0.5,0.5])
    # pyrosim.Send_Cube(name="Link2", pos=[0,0,0.5] , size=[length, width, height])
    # pyrosim.Send_Joint( name = "Link1_Link2" , parent= "Link2" , child = "Link1" , type = "revolute", position = [0,0,1])
    # pyrosim.Send_Cube(name="Link1", pos=[0,0,0.5] , size=[length, width, height])
    # pyrosim.Send_Joint( name = "Link0_Link1" , parent= "Link1" , child = "Link0" , type = "revolute", position = [0,0,1])
    ...
    pyrosim.Send_Joint( name = "BackLeg" , parent= "Torso" , child = "BackLeg" , type = "revolute", position = [0,0.5,1])
