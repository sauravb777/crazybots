...
class NEURON: 
    ...
    def Allow_Presynaptic_Neuron_To_Influence_Me(self, weight_of_csynapse, value_of_presyn_neuron):
        product_value = weight_of_csynapse*value_of_presyn_neuron
        self.Add_To_Value(product_value)
